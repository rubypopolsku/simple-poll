...
ActiveRecord::Schema[7.0].define(version: 2022_12_11_141510) do
  ...
  create_table "votes", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "poll_answer_id", null: false
    t.uuid "poll_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.uuid "user_id"
    t.index ["poll_answer_id"], name: "index_votes_on_poll_answer_id"
    t.index ["poll_id"], name: "index_votes_on_poll_id"
    t.index ["user_id"], name: "index_votes_on_user_id"
  end

  add_foreign_key "poll_answers", "polls"
  add_foreign_key "votes", "poll_answers"
